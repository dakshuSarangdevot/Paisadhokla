...
[APPROVE/REJECT] 👇
        ...
        await context.bot.send_message(OWNER_CHAT_ID, owner_msg, parse_mode=ParseModeConst.MARKDOWN, 
...
async def buy_points(update, context):
    ...
    markup = InlineKeyboardMarkup(keyboard)
    await update.message.reply_text("💎 **CHOOSE PACKAGE:**", reply_markup=markup, parse_mode=ParseModeConst.MARKDOWN)
...
✅ Send **screenshot** after payment!
    ...
    await query.edit_message_text(msg, parse_mode=ParseModeConst.MARKDOWN, reply_markup=InlineKeyboardMarkup(keyboard))
...
async def confirm_payment(update, context):
    ...
    cursor.execute(
        ...
        (user_id, package['name'], package['points'], package['price'], 
